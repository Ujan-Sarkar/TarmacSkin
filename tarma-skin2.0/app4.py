...
CONTRACT_ADDRESS = "0xe17F66EE371C652295d87020052eDC4f96CbD386" # From your code
ABI_FILE_PATH = Path("contract_abi.json")
DEPLOYER_PRIVATE_KEY = "0xd90fdecfc4ef64b223524fd14912681295858db015ed9eba209a0b2e22c9ee4b" # From your code
...
if not web3.is_connected():
    ...
    # Check against placeholder AND actual address before loading contract
    if CONTRACT_ABI and CONTRACT_ADDRESS != "YOUR_DEPLOYED_CONTRACT_ADDRESS_HERE":
        ...
        elif contract is None and CONTRACT_ADDRESS != "YOUR_DEPLOYED_CONTRACT_ADDRESS_HERE":
             print(f"Contract object initialization failed for address {CONTRACT_ADDRESS}")
...
def get_latest_demo_data():
    ...
    try:
        ...
        # but ALWAYS pass load=70.0 for real-time mode processing.
        ...
        # Debug prints (unchanged, but will now show load=70.0 being used)
...
def create_workorder():
    # ... (Web3 logic) ...
    # ... (Error handling) ...
    return jsonify({"error": "Workorder endpoint placeholder"}), 500 # Keep placeholder or full logic
